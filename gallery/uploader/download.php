...
foreach($list as $data) {
    ...
    $zip->addFile(IMAGE_DIR_NAME . '/' . $data['imgFileName'], $dirName . '/' . OUTPUT_IMG_NAME);
    $zip->addFile(IMAGE_DIR_NAME . '/' . $data['thmFileName'], $dirName . '/' . OUTPUT_THM_NAME);
    if ($theme['isRemake']) {
        $zip->addFile(IMAGE_DIR_NAME . '/' . $data['origFileName'], $dirName . '/' . OUTPUT_ORIG_NAME);
    }
