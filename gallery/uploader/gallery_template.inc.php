...
<div class="article">
    ...
    <div class="section">
        ...
        <label for="<?php echo $data['id']; ?>"><img src="<?php echo $data['thmFile']; ?>" alt="<?php echo $data['handle']; ?>" /></label>
        <div class="figure">
            <b><?php echo $data['handle']; ?> #<?php echo $data['uid'] ?></b>
            <div class="cite"><?php echo $data['title']; ?></div>
            <a href="<?php echo $data['imgFile']; ?>"><img src="<?php echo $data['imgFile'] ?>" alt="<?php echo $data['title']; ?>" /></a>
