...
input:checked + * + .figure     {visibility:visible;z-index:10;opacity:1;}
    .figure img                 {box-shadow:0 0 5px rgba(20,20,20,.4);max-height:80%;max-width:100%;}
	...
	.figure input + a			{display:none;}
	.figure input:checked + a	{display:inline;}
</style>
</head>
<body>
...
<div class="nav"><button class="button2" type="submit"><label for="<?php echo $data['id'] ?>_new">リメイク前</label></button><button class="button2" type="submit"><label for="<?php echo $data['id'] ?>_old">リメイク後</label></button></div>
			<input type="radio" name="<?php echo $data['id'] ?>" id="<?php echo $data['id'] ?>_old" checked="checked" />
            <a href="<?php echo $data['id']; ?>/teiki.jpg"><img src="<?php echo $data['id'] ?>/teiki.jpg" alt="<?php echo $data['title']; ?>_old" /></a>
			<input type="radio" name="<?php echo $data['id'] ?>" id="<?php echo $data['id'] ?>_new" />
			<a href="<?php echo $data['id'] ?>/teiki_2.jpg"><img src="<?php echo $data['id'] ?>/teiki_2.jpg" alt="<?php echo $data['title']; ?>_new" /></a>
