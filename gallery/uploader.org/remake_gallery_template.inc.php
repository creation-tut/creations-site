...
<div class="article">
    ...
    <div class="section">
        ...
        <div class="figure">
			...
			<div class="nav"><label for="<?php echo $data['id'] ?>_old">リメイク前</label><label for="<?php echo $data['id'] ?>_new">リメイク後</label></div>
			...
			<a href="<?php echo $data['id'] ?>/teiki2.jpg"><img src="<?php echo $data['id'] ?>/teiki2.jpg" alt="<?php echo $data['title']; ?>_new" /></a>
