	...
	public static void main(String args[]) throws IOException {
		...
		try {
			...
			for (int k = 0; k < n; k++) {
				...
				pw1.println(".highslide-number\t{display: inline;padding-right: 1em;color: white;}");
				pw1.println(".highslide-gallery\t{text-align:center;max-width:646px; margin:0px auto;background-color:#808080;border-right:double 9px #57d8ff;border-left:double 9px #57d8ff;}");
				...
				pw1.println("\t\t\t<h1><a href=\"http://creations-site.sakura.ne.jp/\"><img src=\"http://creations-site.sakura.ne.jp/img/logo.jpg\" width=\"180\" height=\"130\" alt=\"Creation's Graffiti\"></a></h1>");
				...
				pw1.println("\t\t\t</div>");
				pw1.println("\t\t</div>");
				pw1.println("\t\t<div id=\"main\"><h2>▼2012年度" + args[1] + "月定期作品▲</h2>");
				...
				pw1.println("\t\t\t\t\t<div style=\"background:#57d8ff;text-indent: 1ex;text-align:left;border-left:double 9px;font: bold x-large 'serif','ＭＳ 明朝';margin:0px; \">▼" + people[k][0] + "</div>");//作品タイトルを書き込む
				...
				pw1.println("\t\t\t\t\t<div style=\"background:#57d8ff;text-align:right;padding-right:1ex;border-right:double 9px;font: bold x-large 'serif','ＭＳ 明朝'; \">Created by " + people[k][1] + "▲</div>");//HNを書き込む
				pw1.println("\t\t\t\t</div>");
			...
			pw2.println("\t\t\t<h1><a href=\"http://creations-site.sakura.ne.jp/\"><img src=\"http://creations-site.sakura.ne.jp/img/logo.jpg\" width=\"180\" height=\"130\" alt=\"Creation's Graffiti\"></a></h1>");
			...
			pw2.println("\t\t<div id=\"main\"><h2>■2012年度" + args[1] + "月定期作品</h2>");
			...
			pw2.println("\t\t\t\t\t<div style=\"background:#57d8ff;text-indent: 1ex;border-left:double 9px;\">▼Creators List</div>");
			...
			pw2.println("\t\t\t\t\t<div style=\"background:#57d8ff;text-align:right;padding-right:1ex;border-right:double 9px;\">Thumbnail▲</div>");
			pw2.println("\t\t\t\t</div>");
