			...
			for (int k = 0; k < n; k++) {
				...
				if (k == n - 1) {
					...
					pw1.println("\t\t\t\t\t<a href=\"" + (kex + 1) + ".html\">■次のイラストへ&gt;&gt;</a>\n\t\t\t\t</h3>");
                                        ...
                                        if(k<9){
                                        	pw1.println("<input type=\"button\" value=\"リメイク前\" onclick=\"img.src=\'../"+args[2]+"/0"+kex+"/teiki2.jpg'\">"); //ボタンの対応
                                                pw1.println("<input type=\"button\" value=\"リメイク後\" onclick=\"img.src=\'../"+args[2]+"/0"+kex+"/teiki.jpg'\">");
                                        }
                                        else{
                                                pw1.println("<input type=\"button\" value=\"リメイク前\" onclick=\"img.src=\'../"+args[2]+"/"+kex+"/teiki2.jpg'\" border=\"0\"> "); //ボタンの対応
                                                pw1.println("<input type=\"button\" value=\"リメイク後\" onclick=\"img.src=\'../"+args[2]+"/"+kex+"/teiki.jpg'\" border=\"0\">");
                                            }
				...
				if (kex == 1) {
					pw1.println("\t\t\t\t\t<a class=\"highslide\" id=\"thumb1\" href=\"../" + args[2] + "/01/teiki.jpg\" title=\"teiki\" onclick=\"return hs.expand(this)\"><img src=\"../" + args[2] + "/01/teiki.jpg\" alt=\"pic\" name=\"img\" /></a>");
					...
					pw1.println("\t\t\t\t\t</div>");
					if (n <= 9) {
						pw1.println("\t\t\t\t\t\t<a class=\"highslide\" id=\"thumb1\" href=\"../" + args[2] + "/0" + n + "/teiki.jpg\" title=\"teiki\" onclick=\"return hs.expand(this)\"><img src=\"../" + args[2] + "/0" + n + "/teiki.jpg\" alt=\"pic\" name=\"img\" /></a>");
					} else {
						pw1.println("\t\t\t\t\t\t<a class=\"highslide\" id=\"thumb1\" href=\"../" + args[2] + "/" + n + "/teiki.jpg\" title=\"teiki\" onclick=\"return hs.expand(this)\"><img src=\"../" + args[2] + "/" + n + "/teiki.jpg\" alt=\"pic\" name=\"img\" /></a>");
					}
					...
					for (int p = 1; p <= n; p++) {
						if (p <= 9 && p != kex) {
							...
							pw1.println("\t\t\t\t\t</div>");
							pw1.println("\t\t\t\t\t\t<a class=\"highslide\" id=\"thumb1\" href=\"../" + args[2] + "/0" + p + "/teiki.jpg\" title=\"teiki\" onclick=\"return hs.expand(this)\"><img src=\"../" + args[2] + "/0" + p + "/teiki.jpg\" alt=\"pic\" name=\"img\" /></a>");
							pw1.println("\t\t\t\t\t\t<div class=\"hidden-container\">");
						} else {
							pw1.println("\t\t\t\t\t</div>");
							pw1.println("\t\t\t\t\t\t<a class=\"highslide\" id=\"thumb1\" href=\"../" + args[2] + "/" + p + "/teiki.jpg\" title=\"teiki\" onclick=\"return hs.expand(this)\"><img src=\"../" + args[2] + "/" + p + "/teiki.jpg\" alt=\"pic\" name=\"img\" /></a>");
							pw1.println("\t\t\t\t\t<div class=\"hidden-container\">");
						}
					}
					pw1.println("\t\t\t\t\t</div>");
