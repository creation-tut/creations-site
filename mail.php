...
$site_top = "http://creations-site.sakura.ne.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "creation@creations-site.sakura.ne.jp, m0111189a9@edu.teu.ac.jp";
...
$Referer_check_domain = "creations-site.sakura.ne.jp";
...
$subject = "Creations Graffiti メッセージ送信確認";
...
$refrom_name = "東京工科大学 公認CGサークル Creation";
...
<?php copyright(); ?>
<!--  CV率を計測する場合ここにAnalyticsコードを貼り付け -->		</div>
		<div class="footer">Copyright 2000-2014 Creation all rights reserved.</div>
	</div>
</body>
</html>
